...
$search_result = filterTable($query);
    ...
    $query = "SELECT * FROM `project-registration` where `InternsSelected` = ''";
    $search_result = filterTable($query);
}
...
if(isset($_POST['apply']))
{
   ...
   $sql = "UPDATE `project-registration`  SET `InternsSelected`='$first_name $last_name,' WHERE `id`= '$var_value' ";
