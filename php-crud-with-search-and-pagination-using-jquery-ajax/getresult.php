...
$queryCondition = "";
if(!empty($_POST["name"])) {
$queryCondition .= " WHERE `SmeName` LIKE '" . $_POST["name"] . "%'";
}
...
$queryCondition .= " `SMELastName` LIKE '" . $_POST["code"] . "%'";
}

$orderby = " ORDER BY `id` desc";
$sql = "SELECT * FROM `sme` " . $queryCondition;
...
?>
<tr id="sme-<?php echo $result[$k]["id"]; ?>">
<td class="name"><?php echo $result[$k]["SmeName"]; ?></td>
<td class="code"><?php echo $result[$k]["SMELastName"]; ?></td>
<td class="category"><?php echo $result[$k]["SmeEmail"]; ?></td>
<td class="price"><?php echo $result[$k]["SmePhone"]; ?></td>
<td class="action">
